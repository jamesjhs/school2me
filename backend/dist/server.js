...
const getRequestId = (res) => String(res.getHeader('x-request-id') ?? 'unknown');
const shouldDebugLogRequest = (req) => authDebugPathPrefixes.some((prefix) => req.path.startsWith(prefix));
